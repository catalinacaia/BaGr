...
<br><br><br><br>
<form id="passes2">  
            Creaza mai multe ecusoane folosind un document .csv:<br><br>
				   ...
				   Format ecuson: <div class="select-wrapper">
				                    <select name="format" id="format">
							           <option value="">- Format ecuson -</option>
...
<a href="crearecsv.php" class="button">Creaza ecuson</a>
